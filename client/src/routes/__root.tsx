...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Beyond20 | Oracle Cloud, SAP, AWS & Azure Training Institute" },
      { name: "description", content: "Beyond20 offers full-fledged Oracle Cloud, SAP, AWS, Azure and Digital Marketing training by 15+ years experienced trainers. Our students work at Infosys, Wipro and other top MNCs." },
      { property: "og:title", content: "Beyond20" },
      { property: "og:description", content: "Go Beyond. Skill Beyond. Career Beyond Limits. Master Oracle Cloud, SAP, AWS, Azure, and Digital Marketing." },
